...
###########################################################
# For Round 2 Only all scenarios
if PROJECT == "FU2":
    TRANSFORM_PROJECTS = collections.OrderedDict([
        ...
        (2025, {'hwy':['Futures_H10_Vision_Zero'],
                'trn':['Futures_H10_Vision_Zero']
        }),
        (2030, {'hwy':['ReX_express'],
                'trn':['ReX_express']
        }),
        (2035, {'hwy':[],
                'trn':[]
        ...
        (2050, {'hwy':['Futures_C6_Tolls_on_Freeways'],
                'trn':['Futures_C6_Tolls_on_Freeways']
        })
    ])
...
# For Round 2 Only all scenarios
if PROJECT == "FU2":
    TRANSFORM_PROJECTS_CGBF = collections.OrderedDict([
        (2015, {'hwy':[],
                'trn':[]
        }),
        (2020, {'hwy':[],
        ...
        (2025, {'hwy':['Transform_Valley_Link'],
                'trn':['Transform_Valley_Link']
        }),
        (2030, {'hwy':['Transform_Dumbarton_Rail'],
                'trn':['MAJ_SanJose_LRT_Subway',
        ...
        (2035, {'hwy':[],
                'trn':['Caltrain_PCBB10_NoHSR']
        }),
        (2040, {'hwy':['Transform_SMART_To_Richmond'],
                'trn':['Transform_VTA_NorthSJ_Subway',
                       'Transform_SMART_To_Richmond']
        }),
        (2045, {'hwy':[],
                'trn':['Transform_VTA_LRT_Automation']
        }),
        (2050, {'hwy':['Crossings3'],
                'trn':['Crossings3']
        })
...
for YEAR in COMMITTED_PROJECTS.keys():
    ...
    if PROJECT == "FU1":
        ...
        NETWORK_PROJECTS[YEAR] = {
            'hwy':COMMITTED_PROJECTS[YEAR]['hwy'] + MAJOR_PROJECTS[YEAR]['hwy'] + TRANSFORM_PROJECTS[YEAR]['hwy'],
            'trn':COMMITTED_PROJECTS[YEAR]['trn'] + MAJOR_PROJECTS[YEAR]['trn'] + TRANSFORM_PROJECTS[YEAR]['trn']
        }
...
if SCENARIO=="CleanAndGreen":
    ...
    # With protected segments on SLR 
    if PROJECT != "FU2":
        # Sea Level Rise in 2045
        NETWORK_PROJECTS[2045]['trn'].append("Adapt_To_SLR1")
    ...
    if PROJECT == "FU2":
        NETWORK_PROJECTS[2045]['hwy'].append("Adapt_To_SLR2")
        NETWORK_PROJECTS[2045]['trn'].append("Adapt_To_SLR2")
