...
if __name__ == '__main__':
    ...
    parser.add_argument("netvariant", choices=["Baseline", "Blueprint", "Alt1", "Alt2", "NextGenFwy","TIP2023", "NGFNoProject", "NGFNoProjectNoSFCordon", "NGFround2NoProject"], help="Specify which network variant network to create.")
    ...
    for YEAR in NETWORK_PROJECTS.keys():
        ...
        if NET_VARIANT=="Baseline" and YEAR>=2035:
            ...
            if YEAR >= 2035 and YEAR < 2050:
                BP_SLR_PROJECT = {'name':"BP_Sea_Level_Rise_Inundation", 'kwargs':{'MODELYEAR':'2035', 'SCENARIO':"'BP_Basic'"}}
            if YEAR == 2050:
                BP_SLR_PROJECT = {'name':"BP_Sea_Level_Rise_Inundation", 'kwargs':{'MODELYEAR':'2050', 'SCENARIO':"'BP_Basic'"}}
