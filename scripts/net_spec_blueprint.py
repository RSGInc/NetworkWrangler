...
BLUEPRINT_PROJECTS = collections.OrderedDict([
        ...
        (2030, {'hwy':['MAJ_SanPablo_BRT',
                       {'name':'BP_Tolls_On_Congested_Freeways_2030',                                     'variants_exclude':['NGFNoProject', 'NGFNoProjectNoSFCordon']},
                       {'name':'BP_Vision_Zero',                                                          'variants_exclude':['NGFNoProject', 'NGFNoProjectNoSFCordon']},
                       ...
                       {'name':'EXP_uncommitted_all',              'kwargs':{'MODELYEAR':'2030'},         'variants_exclude':['Alt1', 'NGFNoProject', 'NGFNoProjectNoSFCordon']},
                ...
                'trn':['BP_PDA_Transit_Enhancements',
                       ...
                       {'name':'FBP_MU_061_ReX_Green',                                                    'variants_exclude':['NGFNoProject', 'NGFNoProjectNoSFCordon']},
                       'MAJ_SanPablo_BRT',
                       'FBP_MU_044_Richmond_Ferry_Serv_Incr',
                       {'name':'Transform_Valley_Link',                                                   'variants_exclude':['Alt2']},
                       ...
                       {'name':'FBP_MuniForward_Uncommitted_Rail',                                        'variants_exclude':['NGFNoProject', 'NGFNoProjectNoSFCordon']},
                       {'name':'FBP_CC_036_I80_ExpBus_Impr',                                              'variants_exclude':['NGFNoProject', 'NGFNoProjectNoSFCordon']},
                       'FBP_CC_021_Ant_Mart_Herc_Ferry',
                       'FBP_AL_045_Oak_Ala_Access_Pr',
        ...
        (2035, {'hwy':[{'name':'MAJ_MuniForward_Uncommitted',                                             'variants_exclude':['NGFNoProject', 'NGFNoProjectNoSFCordon']},
                       ...
                       {'name':'EXP_uncommitted_all',                  'kwargs':{'MODELYEAR':'2035'},     'variants_exclude':['Alt1', 'NGFNoProject', 'NGFNoProjectNoSFCordon']},
        ...
        (2040, {'hwy':[{'name':'BP_Vision_Zero', 'variants_exclude':['NGFNoProject', 'NGFNoProjectNoSFCordon']},
                       ...
                       {'name':'EXP_uncommitted_all',                            'kwargs':{'MODELYEAR':'2040'},    'variants_exclude':['Alt1', 'NGFNoProject', 'NGFNoProjectNoSFCordon']},
        ...
        (2045, {'hwy':[{'name':'BP_Vision_Zero',                                                          'variants_exclude':['NGFNoProject', 'NGFNoProjectNoSFCordon']},
                       {'name':'EXP_uncommitted_all',              'kwargs':{'MODELYEAR':'2045'},         'variants_exclude':['Alt1', 'NGFNoProject', 'NGFNoProjectNoSFCordon']},
