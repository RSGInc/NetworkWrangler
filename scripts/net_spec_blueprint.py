...
BLUEPRINT_PROJECTS = collections.OrderedDict([
        ...
        (2025, {'hwy':['RRSP_Alameda_Point_Transit_Improvements',
                       ...
                       {'name':'FBP_CC_040_041_042_I680_SR4_Int_Phases_1_2_4_5', 'variants_exclude':['Alt1'], 'kwargs':{'PHASE':"'1'"}},
                       {'name':'FBP_CC_040_041_042_I680_SR4_Int_Phases_1_2_4_5', 'variants_exclude':['Alt1'], 'kwargs':{'PHASE':"'2'"}},
                       {'name':'EXP_uncommitted_all', 'variants_exclude':['Alt1'], 'kwargs':{'MODELYEAR':'2025'}},
                       {'name':'EIR1_EXP_uncommitted_all', 'variants_include':['Alt1'], 'kwargs':{'MODELYEAR':'2025'}},
        ...
        (2030, {'hwy':['MAJ_SanPablo_BRT',
                     ...
                     #  'FBP_MR_018_US101_BOS',
                       ...
                       {'name':'FBP_CC_040_041_042_I680_SR4_Int_Phases_1_2_4_5', 'variants_exclude':['Alt1'], 'kwargs':{'PHASE':"'4'"}},
                       'FBP_CC_021_Ant_Mart_Herc_Ferry',
                       {'name':'EXP_uncommitted_all',  'variants_exclude':['Alt1'], 'kwargs':{'MODELYEAR':'2030'}},
                       {'name':'EIR1_EXP_uncommitted_all', 'variants_include':['Alt1'], 'kwargs':{'MODELYEAR':'2030'}},
        ...
        (2035, {'hwy':['MAJ_MuniForward_Uncommitted',
                       ...
                       {'name':'MAJ_SOL070020_I80_I680_SR12_Int_2B_7', 'variants_exclude':['Alt1'], 'kwargs':{'PHASE':"'3'"}},
                       {'name':'MAJ_SOL070020_I80_I680_SR12_Int_2B_7', 'variants_exclude':['Alt1'], 'kwargs':{'PHASE':"'4'"}},
                       ...
                       {'name':'EXP_uncommitted_all', 'variants_exclude':['Alt1'], 'kwargs':{'MODELYEAR':'2035'}},
                       {'name':'EIR1_EXP_uncommitted_all', 'variants_include':['Alt1'], 'kwargs':{'MODELYEAR':'2035'}},
        ...
        (2040, {'hwy':['BP_Vision_Zero',
                       ...
                       {'name':'FBP_CC_040_041_042_I680_SR4_Int_Phases_1_2_4_5', 'variants_exclude':['Alt1'], 'kwargs':{'PHASE':"'5'"}},
                       {'name':'EXP_uncommitted_all', 'variants_exclude':['Alt1'], 'kwargs':{'MODELYEAR':'2040'}},
                       {'name':'EIR1_EXP_uncommitted_all', 'variants_include':['Alt1'], 'kwargs':{'MODELYEAR':'2040'}},
                       ...
                       {'name':'EIR2_Val_Link_ExpressBus', 'variants_exclude':['Alt2']},
        ...
        (2045, {'hwy':['BP_Vision_Zero',
                       {'name':'EXP_uncommitted_all', 'variants_exclude':['Alt1'], 'kwargs':{'MODELYEAR':'2045'}},
                       {'name':'EIR1_EXP_uncommitted_all', 'variants_include':['Alt1'], 'kwargs':{'MODELYEAR':'2045'}},
        ...
        (2050, {'hwy':['BP_Vision_Zero',
                       {'name':'MAJ_SOL070020_I80_I680_SR12_Int_2B_7', 'variants_exclude':['Alt1'], 'kwargs':{'PHASE':"'6'"}},
