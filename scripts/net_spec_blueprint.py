...
BLUEPRINT_PROJECTS = collections.OrderedDict([
        ...
        (2025, {'hwy':[{'name': 'RRSP_Alameda_Point_Transit_Improvements', 'kwargs':{'BUILT':"'unbuilt'"}, 'branch':'PBA50plus_DBP'},
                       ...
                       {'name':'EXP_uncommitted_noAllLaneTolling', 'kwargs':{'MODELYEAR':'2025'},           'variants_include':['NGFNoProject', 'NGFNoProjectNoSFCordon'],       'variants_exclude':['NGFround2NoProject']},
        ...
        (2030, {'hwy':['MAJ_SanPablo_BRT',
                       ...
                       {'name':'EXP_uncommitted_noAllLaneTolling', 'kwargs':{'MODELYEAR':'2030'},         'variants_include':['NGFNoProject', 'NGFNoProjectNoSFCordon'],    'variants_exclude':['NGFround2NoProject']},
        ...
        (2035, {'hwy':[{'name':'MAJ_MuniForward_Uncommitted',                                             'variants_exclude':['NGFNoProject', 'NGFNoProjectNoSFCordon'], 'branch':'PBA50plus_DBP'},
                       ...
                       {'name':'EXP_uncommitted_noAllLaneTolling',     'kwargs':{'MODELYEAR':'2035'},     'variants_include':['NGFNoProject', 'NGFNoProjectNoSFCordon'],    'variants_exclude':['NGFround2NoProject']},
        ...
        (2040, {'hwy':[{'name':'BP_Vision_Zero',                                                          'variants_exclude':['NGFNoProject', 'NGFNoProjectNoSFCordon','NGFround2NoProject']},
                       ...
                       {'name':'EXP_uncommitted_noAllLaneTolling',               'kwargs':{'MODELYEAR':'2040'},    'variants_include':['NGFNoProject', 'NGFNoProjectNoSFCordon'],    'variants_exclude':['NGFround2NoProject']},
        ...
        (2045, {'hwy':[{'name':'BP_Vision_Zero',                                                          'variants_exclude':['NGFNoProject', 'NGFNoProjectNoSFCordon','NGFround2NoProject']},
                       ...
                       {'name':'EXP_uncommitted_noAllLaneTolling', 'kwargs':{'MODELYEAR':'2045'},         'variants_include':['NGFNoProject', 'NGFNoProjectNoSFCordon'],    'variants_exclude':['NGFround2NoProject']},
