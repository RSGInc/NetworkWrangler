...
BLUEPRINT_PROJECTS = collections.OrderedDict([
        ...
        (2025, {'hwy':[{'name':'RRSP_Alameda_Point_Transit_Improvements',                                   'tag':'PBA50_Blueprint'},
                       ...
                       {'name':'Transform_SR37_Widening_Interim',                                           'variants_exclude':['Alt1'],'tag':'PBA50_Blueprint'},
                       'MAJ_SF_Congestion_Pricing',
                       {'name':'MAJ_Geary_BRT_Phase2',                                                      'tag':'PBA50_Blueprint'},
                       ...
                       {'name':'EXP_uncommitted_all',           'kwargs':{'MODELYEAR':'2025'},              'variants_exclude':['Alt1', 'NextGenFwy'],'tag':'PBA50_Blueprint'},
                       ...
                       {'name':'MAJ_Bay_Area_Forward_all',      'kwargs':{'MODELYEAR':'2025'},              'tag':'PBA50_Blueprint'},
                ...
                'trn':[{'name':'MAJ_Geary_BRT_Phase2',                                                    'tag':'PBA50_Blueprint'},
        ...
        (2030, {'hwy':['MAJ_SanPablo_BRT',
                     ...
                     #  'FBP_MR_018_US101_BOS',
                       ...
                       {'name':'EXP_uncommitted_all',           'kwargs':{'MODELYEAR':'2030'},            'variants_exclude':['Alt1', 'NextGenFwy'], 'tag':'PBA50_Blueprint'},
                       ...
                       {'name':'FBP_SF_012_Geneva_Harney_BRT',  'kwargs':{'MODELYEAR':'2030'},              'tag':'PBA50_Blueprint'},
                       {'name':'MAJ_Bay_Area_Forward_all',      'kwargs':{'MODELYEAR':'2030'},              'tag':'PBA50_Blueprint'},
        ...
        (2035, {'hwy':['MAJ_MuniForward_Uncommitted',
                       ...
                       {'name':'FBP_SF_012_Geneva_Harney_BRT',  'kwargs':{'MODELYEAR':'2035'},              'tag':'PBA50_Blueprint'},
                       {'name':'EXP_uncommitted_all',           'kwargs':{'MODELYEAR':'2035'},            'variants_exclude':['Alt1', 'NextGenFwy'], 'tag':'PBA50_Blueprint'},
                       {'name':'EIR1_EXP_uncommitted_all',      'kwargs':{'MODELYEAR':'2035'},            'variants_include':['Alt1']},
                       {'name':'MAJ_Bay_Area_Forward_all',      'kwargs':{'MODELYEAR':'2035'},              'tag':'PBA50_Blueprint'},
        ...
        (2040, {'hwy':['BP_Vision_Zero',
                       ...
                       {'name':'EXP_uncommitted_all',           'kwargs':{'MODELYEAR':'2040'},            'variants_exclude':['Alt1', 'NextGenFwy'], 'tag':'PBA50_Blueprint'},
                       {'name':'EIR1_EXP_uncommitted_all',      'kwargs':{'MODELYEAR':'2040'},            'variants_include':['Alt1']},
                       {'name':'FBP_SF_012_Geneva_Harney_BRT',  'kwargs':{'MODELYEAR':'2040'},              'tag':'PBA50_Blueprint'},
                       {'name':'MAJ_Bay_Area_Forward_all',      'kwargs':{'MODELYEAR':'2040'},              'tag':'PBA50_Blueprint'},
        ...
        (2045, {'hwy':['BP_Vision_Zero',
                       {'name':'EXP_uncommitted_all',           'kwargs':{'MODELYEAR':'2045'},            'variants_exclude':['Alt1', 'NextGenFwy'], 'tag':'PBA50_Blueprint'},
                       {'name':'EIR1_EXP_uncommitted_all',      'kwargs':{'MODELYEAR':'2045'},            'variants_include':['Alt1']},
                       {'name':'MAJ_Bay_Area_Forward_all',      'kwargs':{'MODELYEAR':'2045'},              'tag':'PBA50_Blueprint'},
        ...
        (2050, {'hwy':['BP_Vision_Zero',
                       ...
                       {'name':'MAJ_Bay_Area_Forward_all',      'kwargs':{'MODELYEAR':'2050'},              'tag':'PBA50_Blueprint'},
                       'EXP_Blueprint',
